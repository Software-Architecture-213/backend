...
import com.example.brandservice.filter.JwtAuthenticationFilter;
        ...
        http
                ...
                .authorizeHttpRequests(authManager -> {
                    authManager
                            ...
                            .requestMatchers(HttpMethod.PATCH, apiEndpointSecurityInspector.getPublicPatchEndpoints().toArray(String[]::new)).permitAll()
