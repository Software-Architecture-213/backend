...
INSERT INTO Voucher (id, code, type, image_url, value_type, value, description, expired_at, status, promotion_id, max_counts, created_counts, created_at, updated_at)
VALUES
...
INSERT INTO VoucherUser (id, user_id, email, voucher_id, qr_code, status, redeemed_at, created_at, updated_at)
VALUES
...
INSERT INTO Brand (id, display_name, image_url, username, password, field, gps_latitude, gps_longitude, status, created_at, updated_at)
VALUES
...
INSERT INTO ConversionRule (id, voucher_id, game_id, created_at, updated_at)
VALUES 
...
-- ConversionRule_Item Table Inserts
INSERT INTO ConversionRule_Item (conversion_rule_id, item_id, quantity)
VALUES 
